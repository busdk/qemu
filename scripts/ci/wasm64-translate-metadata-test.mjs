...
assert.match(runtime, /tcg_wasm64_translate_entry_for_lookup_diagnose/);
assert.match(runtime, /tcg_wasm64_record_live_generated_exec_metadata_lookup/);
...
assert.match(runtime, /live_generated_exec_reject_direct_memory/);
assert.match(runtime, /\\"reject_direct_memory\\":\[/);
assert.match(runtime, /\\"route\\":\\"%s\\",\\"op\\":%u,\\"op_name\\":\\"%s\\"/);
...
assert.match(runtime, /tciMovlPoolRelocation/);
assert.match(runtime, /tciMovlPoolTargetInTb/);
assert.match(runtime, /normalizeGeneratedOutputWords/);
assert.match(runtime, /uint32_t tb_code_size_arg/);
assert.match(runtime, /metadata->generated_output_size > tb->tc\.size/);
assert.match(runtime, /metadata->generated_output_size, tb_code_size/);
...
assert.match(runtime, /TCG_WASM64_TRANSLATE_LOOKUP_CACHE_NULL/);
assert.match(runtime, /TCG_WASM64_TRANSLATE_LOOKUP_NO_ENTRY/);
assert.match(runtime, /TCG_WASM64_TRANSLATE_LOOKUP_ENTRY_INVALID/);
assert.match(runtime, /TCG_WASM64_TRANSLATE_LOOKUP_KEY_MISMATCH/);
assert.match(runtime, /live_generated_exec_metadata_lookup_status/);
assert.match(runtime, /tcg_wasm64_translate_begin_total/);
assert.match(runtime, /tcg_wasm64_live_generated_exec_riscv64_env_field_supported/);
assert.match(runtime, /target_arch\(\) == SYS_EMU_TARGET_RISCV64/);
assert.match(runtime, /op == INDEX_op_ld \|\| op == INDEX_op_st/);
assert.match(runtime, /const int32_t riscv64_pc_offset = 0x1218/);
assert.match(runtime, /offset == riscv64_pc_offset/);
assert.match(runtime, /\\"metadata_lookup\\":\{\\"ok\\":%" PRIu64/);
assert.match(runtime, /\\"cache_null\\":%" PRIu64/);
assert.match(runtime, /\\"no_entry\\":%" PRIu64/);
assert.match(runtime, /\\"entry_invalid\\":%" PRIu64/);
assert.match(runtime, /\\"key_mismatch\\":%" PRIu64/);
assert.match(runtime, /\\"metadata_lookup_sample\\":/);
...
assert.match(runtime, /MO_AMASK/);
assert.match(runtime, /MO_ALIGN_TLB_ONLY/);
...
assert.match(generatedEquivalence, /r4s19-tci-movl-pool-relocation-executes/);
assert.match(generatedEquivalence, /r4s19-tci-movl-changed-destination-rejects/);
assert.match(generatedEquivalence, /r4s19-tci-movl-out-of-range-pool-target-rejects/);
assert.match(generatedEquivalence, /r4s19-call-pool-relocation-still-rejects/);
...
assert.match(generatedEquivalence, /r4s8b-length-mismatch-still-rejects/);
...
assert.match(generatedEquivalence, /normalizeMetadataOutputWords/);
...
assert.match(generatedEquivalence, /r4s5b-sign-store-rejects-before-inline-ram/);
...
assert.match(generatedEquivalence, /r4s21-direct-memory-multi-access-admitted/);
assert.match(generatedEquivalence, /r4s21-direct-memory-overlap-multi-access-rejects/);
...
assert.match(generatedEquivalence, /RISCV64_ENV_DIRECT_PC_OFFSET = 0x1218/);
assert.match(generatedEquivalence, /r4s21c-riscv64-env-direct-pc-with-qemu-load-store-all-or-nothing/);
assert.match(generatedEquivalence, /r4s21c-riscv64-env-direct-pc-multi-access-admitted/);
assert.match(generatedEquivalence, /r4s21c-riscv64-env-direct-pc-wrong-size-fails-closed/);
assert.match(generatedEquivalence, /r4s21c-riscv64-env-direct-pc-wrong-store-size-fails-closed/);
assert.match(generatedEquivalence, /r4s21c-riscv64-env-direct-pc-wrong-size-rejects/);
assert.match(generatedEquivalence, /r4s21c-riscv64-env-direct-pc-wrong-store-size-rejects/);
assert.match(generatedEquivalence, /r4s21c-riscv64-env-direct-pc-store-later-softmmu-guard-fails-no-commit/);
