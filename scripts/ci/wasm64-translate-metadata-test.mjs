...
assert.match(header, /runloop_attach_probe_env_ready_tbs/);
assert.match(header, /runloop_attach_probe_env_ready_ops/);
assert.match(header, /runloop_attach_probe_missing_value_env_offset/);
assert.match(header, /runloop_attach_probe_missing_base_env_offset/);
assert.match(header, /runloop_attach_probe_missing_branch_env_offset/);
assert.match(header, /runloop_attach_probe_missing_store_env_offset/);
assert.match(header, /runloop_attach_probe_unsupported_hot_tb/);
assert.match(header, /runloop_attach_probe_unsupported_generated_ops/);
assert.match(header, /runloop_attach_probe_unsupported_semantic_shape/);
assert.match(header, /runloop_attach_probe_unsupported_other/);
assert.match(header, /runloop_attach_probe_no_generated_output/);
assert.match(header, /TCG_WASM64_OP_HISTOGRAM_SIZE 256u/);
assert.match(header, /runloop_attach_probe_semantic_first_ops\[\s*\n\s*TCG_WASM64_OP_HISTOGRAM_SIZE\]/);
...
assert.match(runtime, /runloop_attach_probe_env_ready_tbs/);
assert.match(runtime, /runloop_attach_probe_missing_value_env_offset/);
assert.match(runtime, /runloop_attach_probe_missing_base_env_offset/);
assert.match(runtime, /runloop_attach_probe_missing_branch_env_offset/);
assert.match(runtime, /runloop_attach_probe_missing_store_env_offset/);
assert.match(runtime, /tcg_wasm64_count_runloop_attach_probe_env_ready/);
...
assert.match(runtime, /tcg_wasm64_print_runloop_semantic_first_top/);
assert.match(runtime, /runloop_attach_probe_semantic_first_ops\[op\]\+\+/);
