                          ...
                          void *dest, vaddr pc, size_t len)
{
 ...
 do_read:
    ...
    switch (len) {
    case 2:
        if (QEMU_IS_ALIGNED(pc, 2) && QEMU_PTR_IS_ALIGNED(host, 2)) {
        ...
        break;
    case 4:
        if (QEMU_IS_ALIGNED(pc, 4) && QEMU_PTR_IS_ALIGNED(host, 4)) {
        ...
        break;
    case 8:
        if (QEMU_IS_ALIGNED(pc, 8) && QEMU_PTR_IS_ALIGNED(host, 8)) {
