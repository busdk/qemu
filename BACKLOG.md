...
## Deferred From Suspend/Resume Focus - 2026-07-08 09:46:06 EEST

Moved out of `PLAN.md` because the active thread focus is now the R4suspend/native migration-stream path and immediate browser-guest prerequisites. Move an item back to `PLAN.md` only when the operator reopens that accelerator/proof lane or it becomes a direct blocker for suspend/resume acceptance.
